...
impl WindowFlags {
    ...
    pub fn to_window_styles(self) -> (WINDOW_STYLE, WINDOW_EX_STYLE) {
        ...
        let mut style_ex = WS_EX_WINDOWEDGE | WS_EX_ACCEPTFILES | WS_EX_NOACTIVATE;
